...
p5.prototype._isKeyInState = function(key, state) {
  ...
  {
    if('MINUT' === key.toUpperCase())
    {
      warn('Key literal "MINUT" is deprecated and may be removed in a future ' +
        'version of p5.play.  Please use "MINUS" instead.')
    }
...
p5.prototype.KEY = {
    ...
    'PLUS': 107,
    'MINUS': 109,
    'MINUT': 109, // Typo of 'MINUS', deprecated
    'DOT': 110,
    'SLASH1': 111,
    'F1': 112,
    'F2': 113,
